        ...
        <header className={cx('wrapper')}>
            <div className={cx('inner')}>
                <div className={cx('logo')}>
                    <Link to={routesConfig.home} className={cx('logo-link')} onClick={AnotherComponent}>
                    ...
                    {currentUser ? (
                        <>
                            ...
                            <Tippy delay={[0, 200]} content="Hộp thư">
                                <button className={cx('action-btn')}>
                                    <InboxIcon />
                                    <span className={cx('bought')}>3</span>
                                </button>
                            </Tippy>
                        </>
                    ) : (
                    ...
                    <Menu items={userMenu} onChange={handleMenuChange}>
                        {currentUser ? (
                            <Image
                                ...
                                src="https://p16-sign-sg.tiktokcdn.com/aweme/100x100/tos-alisg-avt-0068/e9b9cca4f9131ea3b91f10c9a8221041.jpeg?lk3s=a5d48078&nonce=12877&refresh_token=186367bc6b9be32298bc55ecb6fe9b9a&x-expires=1717826400&x-signature=VUXrdTgSvjQ3X1ljXdmCMJkAvIY%3D&shp=a5d48078&shcp=b59d6b55"
                                alt="Phan An"
